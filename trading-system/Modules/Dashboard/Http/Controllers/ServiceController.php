...
{
    private $view_index  = 'dashboard::pages.services.index';
    private $view_edit   = 'dashboard::pages.services.create_edit';
    ...
    {
        $item = Post::where('type', 'service')->findOrFail($id);
