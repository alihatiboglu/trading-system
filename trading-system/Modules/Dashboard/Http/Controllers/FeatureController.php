...
{
    private $view_index  = 'dashboard::pages.features.index';
    private $view_edit   = 'dashboard::pages.features.create_edit';
    private $route       = 'features';
    ...
    {
        $item = Post::where('type', 'feature')->findOrFail($id);
