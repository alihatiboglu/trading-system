...
{
    private $view_index  = 'dashboard::pages.slider.index';
    private $view_edit   = 'dashboard::pages.slider.create_edit';
    ...
    {
        $item = Post::where('type', 'slider')->findOrFail($id);
