        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('items.create') }}" class="btn btn-outline-primary btn-xs mt-3">{{ __('main.add_new') }}</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="card">
            ...
            <table class="table custom-table table-striped table-hover">
                ...
                @foreach($items as $item)
                    ...
                    <td>
                        <a href="{{ route('items.edit', $item->id) }}" type="button" class="btn btn-info btn-xs btn-flat">
