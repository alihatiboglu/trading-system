...
@section('content')
    ...
    <section class="content">
        <form method='post' enctype="multipart/form-data" action="{{ isset($item) ? route('posts.update', $item->id) : route('posts.store') }}">
