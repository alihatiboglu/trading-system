                ...
                <table class="table mb10">
                    ...
                    <tr>
                        ...
                        <td class="text-right hidden-xs">
                            <a href="{{ route('deposits.paypal') }}" class="btn btn-warning"> {{ __('main.deposit') }}</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="">
                        ...
                        <td>{{ __('main.no_commission') }}</td>
                        <td class="text-right hidden-xs">
                            <a href="{{ route('deposits.visa') }}" class="btn btn-warning"> {{ __('main.deposit') }}</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="">
                        ...
                        <td></td>
                        <td class="text-right hidden-xs">
                            <a href="{{ route('deposits.binance') }}" class="btn btn-warning"> {{ __('main.deposit') }}</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
